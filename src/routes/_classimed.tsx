        ...
        <aside className="app-nav">
          ...
          <div style={{ marginTop: 10, display: "grid", gap: 6 }}>
            ...
            <Link to="/todo" className="navlink">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>
              <span>
                Todo
              </span>
