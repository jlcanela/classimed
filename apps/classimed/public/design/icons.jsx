// Lightweight icon set (heroicons / tabler-inspired). All inline SVG.
...
const ICONS = {
  ...
  books: <><path d="M4 19a2 2 0 0 1 2-2h13"/><path d="M6 17V5a2 2 0 0 1 2-2h11v18H6"/><path d="M9 7h6"/></>,
  book: <><path d="M4 19V5a2 2 0 0 1 2-2h13v18H6a2 2 0 0 1-2-2z"/><path d="M9 3v18"/></>,
  ...
  split: <><path d="M8 3v18"/><path d="M16 3v18"/><path d="M3 12h5"/><path d="M16 12h5"/></>,
  merge: <><path d="M8 3v8"/><path d="M16 3v8"/><path d="M12 11v10"/><path d="M5 11h14"/></>,
  ...
  language: <><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 0 20 15.3 15.3 0 0 1 0-20z"/></>,
  glyph: <><path d="M4 7V5h16v2"/><path d="M9 20h6"/><path d="M12 5v15"/></>,
